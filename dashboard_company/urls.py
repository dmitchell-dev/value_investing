...
data_patterns = (
    [
        ...
        path(
            "<int:pk>/chart/data/debt-to-equity/",
            DebtToEquityDataView.as_view()),
        path(
            "<int:pk>/chart/data/dividend-cover/",
            DividendCoverDataView.as_view()),
        path(
            "<int:pk>/chart/data/roce/",
            RoceDataView.as_view()),
        path(
            "<int:pk>/chart/data/price-to-earnings/",
            PriceToEarningsDataView.as_view()
        ),
        path(
        ...
        path(
            "<int:pk>/chart/data/intrinsic-value/",
            IntrinsicValueDataView.as_view()),
        path(
            "<int:pk>/chart/data/annual-yield/",
            AnnualYieldDataView.as_view()),
        path(
            "<int:pk>/chart/data/fcf-ps/",
            FcfPsDataView.as_view()),
        path(
            "<int:pk>/chart/data/current-ratio/",
            CurrentRatioDataView.as_view()),
        path(
            "<int:pk>/chart/data/total-multi/",
            TotalMultiDataView.as_view()),
        path(
            "<int:pk>/chart/data/current-multi/",
            CurrentMultiDataView.as_view()),
    ],
    "data",
)
