...
from .views import (
    ...
    NetMarginDataView,
    GrossMarginDataView,
    OperatingMarginDataView,
    InterestCoverageDataView,
    DividendPayoutRatioDataView,
    TotalMultiDataView,
    CurrentMultiDataView,
    IntrinsicMultiDataView,
    DashboardTableView,
    SearchResultsListView,
    WishListFilteredListView,
    dashboard_chart,
    htmx_explore,
    dashboard_table,
    company_dash_update,
...
urlpatterns = [
    ...
    path("wishlist-filtered/", WishListFilteredListView.as_view(), name="wishlist_filtered_results"),
...
data_patterns = (
    [
        ...
        path("<int:pk>/chart/data/free-cash-flow/", FreeCashFlowDataView.as_view()),
        path("<int:pk>/chart/data/net-margin/", NetMarginDataView.as_view()),
        path("<int:pk>/chart/data/gross-margin/", GrossMarginDataView.as_view()),
        path("<int:pk>/chart/data/operating-margin/", OperatingMarginDataView.as_view()),
        path("<int:pk>/chart/data/interest-coverage/", InterestCoverageDataView.as_view()),
        path("<int:pk>/chart/data/dividend-payout-ratio/", DividendPayoutRatioDataView.as_view()),
